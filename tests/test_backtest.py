...
def test_backtest_delays_positions_one_bar_and_charges_turnover():
    ...
    result = run_portfolio(closes, positions, initial_capital=100.0, transaction_cost_bps=10.0, slippage_bps=0.0)
...
def test_all_models_share_equal_weight_portfolio_contract():
    ...
    result = run_portfolio(closes, positions, initial_capital=100, transaction_cost_bps=0, slippage_bps=0)
