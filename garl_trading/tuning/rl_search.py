...
def tune_rl_policy(
    ...
    *,
    ...
    validation_features = {
        t: frame.iloc[validation_positions] for t, frame in features.items()
    }
    validation_closes = {
        t: series.iloc[validation_positions] for t, series in closes.items()
    }
    ...
    def objective(trial: optuna.Trial) -> float:
        ...
        except Exception:  # noqa: BLE001 - failed trial receives a finite penalty
            return -10.0
